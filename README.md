...
SWAG(System · Website · App · Game)는 시스템 · 웹사이트 · 앱 · 브라우저 게임 외주 제작을 안내하고 견적 문의를 받는 정적 웹사이트입니다. 상담한 두 사람이 기획부터 배포까지 담당하는 2인 프리랜서 스튜디오의 제작 범위, 프로젝트, 진행 방식, 소개, 문의 흐름을 분리된 페이지에서 안내합니다.

현재 작업 기준은 `v47`입니다. 배포 대상은 GitHub 저장소와 GitHub Pages입니다.
...
- 모션: 관성형 휠 스크롤, 유리 질감 내비게이션, 히어로 파티클 캔버스, 헤드라인 로테이터, 카운트업 숫자, 카드 틸트 · 시인, 서로 반대 방향으로 흐르는 기술 스택 3개 행(일시정지 버튼 포함), 이미지 스캔, 확장 페이지 전환, clip/stagger 모바일 메뉴
...
감사는 320×812, 390×844, 844×390, 768×1024, 1100×900, 1440×1000에서 실행합니다. v47 로컬 빌드는 48개 화면 조합, 문의 · 메뉴 상호작용, 3개 행의 방향 · 속도 · 일시정지 · 모션 감소 검사를 합쳐 **1621/1621 assertions**를 통과했습니다.
